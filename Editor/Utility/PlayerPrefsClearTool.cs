...
namespace MiniGameKit.Editor
{
    ...
    {
        [MenuItem(MiniGameKitEditorPaths.UtilityMenu + "清理本地存档 (PlayerPrefs)", false, 100)]
        public static void ClearSaveData()
        {
            var keys = MiniGameKitEditorPaths.SplitSemicolonPaths(MiniGameKitEditorPaths.PlayerPrefsClearKeys);
            if (keys.Length == 0)
            {
